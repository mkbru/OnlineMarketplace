(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('universal-user-agent'), require('tslib'), require('@azure/cosmos-sign'), require('debug'), require('binary-search-bounds'), require('priorityqueuejs'), require('semaphore'), require('crypto-hash'), require('fast-json-stable-stringify'), require('uuid/v4'), require('@azure/abort-controller'), require('node-fetch')) :
    typeof define === 'function' && define.amd ? define(['exports', 'universal-user-agent', 'tslib', '@azure/cosmos-sign', 'debug', 'binary-search-bounds', 'priorityqueuejs', 'semaphore', 'crypto-hash', 'fast-json-stable-stringify', 'uuid/v4', '@azure/abort-controller', 'node-fetch'], factory) :
    (global = global || self, factory((global.Microsoft = global.Microsoft || {}, global.Microsoft.Azure = global.Microsoft.Azure || {}, global.Microsoft.Azure.Cosmos = {}), global.universalUserAgent, global.tslib_1, global.cosmosSign, global.debugLib, global.bs, global.PriorityQueue, global.semaphore, global.cryptoHash, global.stableStringify, global.uuid, global.AbortController, global.fetch));
}(this, function (exports, universalUserAgent, tslib_1, cosmosSign, debugLib, bs, PriorityQueue, semaphore, cryptoHash, stableStringify, uuid, abortController, fetch) { 'use strict';
